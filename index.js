...
router.get('/:id_company/reports3', isLoggedIn, async (req, res) => {
    ...
    chartLabels.forEach(dateString => {
        const parts = dateString.split('/'); // Split date string into parts search_supplies_combo
...
//-----------------------------------------------------------this function is for get all the sale of the combo (day,month,reay,all) get_all_dish_and_combo
...
async function update_combo_branch(req, res) {
    ...
    //we will reading all the combo of the company for after add to the branch search_supplies_combo
